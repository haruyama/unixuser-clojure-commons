...
(deftest tokenize-test
         ...
         (let [factory (org.apache.lucene.analysis.standard.StandardTokenizerFactory. (doto (java.util.HashMap.) (.put AbstractAnalysisFactory/LUCENE_MATCH_VERSION_PARAM "LUCENE_43")))]
...
(deftest tokenizer-chain-test
         (let [stf (org.apache.lucene.analysis.standard.StandardTokenizerFactory. (doto (java.util.HashMap.) (.put AbstractAnalysisFactory/LUCENE_MATCH_VERSION_PARAM "LUCENE_43")))
               cwff (org.apache.lucene.analysis.cjk.CJKWidthFilterFactory. (java.util.HashMap.))
               lcff (org.apache.lucene.analysis.core.LowerCaseFilterFactory. (doto (java.util.HashMap.) (.put AbstractAnalysisFactory/LUCENE_MATCH_VERSION_PARAM "LUCENE_43")))
